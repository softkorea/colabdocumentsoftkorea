...
@jit
def calculate_schrodinger(N,psi_r,psi_i,c1,c2V,PA,PR,FU):
...
Tp   = T       #  Number of time steps to increment before updating the plot.
...
k0 = np.pi/40 # Wavenumber (note that energy is a function of k)
...
st = timer()
for i in range(10):
    (psi_r,psi_i) = calculate_schrodinger(N,psi_r,psi_i,c1,c2V,PA,PR,FU)
et = timer()
print(et-st)
